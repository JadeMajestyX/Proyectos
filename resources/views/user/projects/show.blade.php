    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="bg-white dark:bg-gray-800 dark:text-gray-100 p-6 shadow sm:rounded-lg">
                <div class="text-gray-700 dark:text-gray-300">{{ $project->description }}</div>
                <div class="text-xs text-gray-500 dark:text-gray-400 mt-2">Creado por: {{ $project->owner->name }} — {{ $project->created_at->diffForHumans() }}</div>
            </div>
