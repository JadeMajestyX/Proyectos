...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p>Tu actividad ha sido reasignada a otro usuario</p>
        </div>
        ...
        <div class="content">
            ...
            <p class="message">
                Te informamos que el ticket que tenías asignado ha sido reasignado a otro miembro del equipo. A continuación encontrarás los detalles:
            </p>
            ...
            <div class="ticket-summary">
                ...
                <div class="ticket-item">
                    <span class="ticket-label">Fecha Cambio</span>
            ...
            <div class="assigned-user">
                <p style="font-size: 12px; color: #666;">Ahora asignado a:</p>
                <p class="user-name">{{ $newUser->name }}</p>
                <p style="font-size: 13px; color: #999;">{{ $newUser->email }}</p>
            </div>
            ...
            <p class="message" style="color: #f39c12; font-style: italic;">
                Si deseas ver los detalles completos del ticket, puedes acceder desde tu panel de control:
            </p>
            ...
            <p class="message" style="margin-top: 30px; font-size: 13px;">
                Si tienes preguntas sobre esta reasignación, puedes ponerte en contacto con el administrador del proyecto.
            </p>
        </div>
