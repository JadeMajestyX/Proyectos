...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p>Un usuario marcó el estado de un ticket</p>
        </div>
        ...
        <div class="content">
            ...
            <p class="message">
                Te informamos que <strong>{{ $changedByName }}</strong> actualizó el estado de un ticket. A continuación encontrarás los detalles principales:
            </p>
            ...
            <div class="ticket-summary">
                ...
                <div class="ticket-item">
                    ...
                    <span class="ticket-value">{{ $oldStatusLabel }}</span>
                </div>
                <div class="ticket-item">
                    <span class="ticket-label">Nuevo estado</span>
                    <span class="ticket-value"><strong>{{ $newStatusLabel }}</strong></span>
                </div>
                <div class="ticket-item">
            ...
            <center>
                <a href="{{ route('admin.tickets.show', $ticket) }}" class="cta-button">
                    Ver Ticket (Admin)
                </a>
            </center>
        ...
        <div class="footer">
            ...
            <p style="margin-top: 10px;">
                <a href="{{ route('admin.tickets.index') }}">Admin Tickets</a> |
